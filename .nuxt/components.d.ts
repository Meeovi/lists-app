...
export const ListsAddListItem: typeof import("../app/components/lists/add-list-item.vue").default
...
export const LazyListsAddListItem: LazyComponent<typeof import("../app/components/lists/add-list-item.vue").default>
